...
function RouterContent() {
  ...
  const renderPage = () => {
    ...
    // Dynamic News detail subpage: /news/<slug>
    if (path.startsWith(NEWS_PATH_PREFIX) && path !== '/news') {
      const slug = path.slice(NEWS_PATH_PREFIX.length);
